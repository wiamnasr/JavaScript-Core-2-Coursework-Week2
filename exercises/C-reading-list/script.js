...
See lines in 18-41 in index.html
...
There are some tests in this `reading-list.test.js` file that you can run by using the command

npm test -- --testPathPattern reading-list.test
