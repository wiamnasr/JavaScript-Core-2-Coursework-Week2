...
See lines in 18-20 in index.html
...
There are some tests in this `list-of-colours.test.js` file that you can run by using the command

npm test -- --testPathPattern list-of-colours.test
